...
$ChecksumUrl = "https://raw.githubusercontent.com/LFDT-web3j/web3j-installer/7c26b9510b0b91be136d65241615ecd3cb23acc7/checksum-linux.txt"
...
$url = "https://github.com/hyperledger-web3j/web3j-cli/releases/download/v${web3j_version}/web3j-shadow-${web3j_version}.zip"
...
if (!($CurrentPath -match $web3j_version)) {
    [Environment]::SetEnvironmentVariable(
            "Path",
            $CurrentPath + ";${env:USERPROFILE}\.web3j\web3j-shadow-${web3j_version}\bin",
